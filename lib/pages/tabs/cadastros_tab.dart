...
class _CadastrosTabState extends State<CadastrosTab> {
  ...
  Widget _buildRegistrationCard({
    ...
    final isAllowed = Perfil.ehAdministrador(widget.userRole);
        ...
        onTap: () {
          if (isAllowed) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text(
                  'Apenas administradores podem cadastrar novos dados.',
                ),
        ...
        return _buildListWrapper(
          ...
          builder: (res) {
            ...
            return _listTile(
              ...
              trailing: Wrap(spacing: 6, children: [_statusBadge(sl, sc)]),
            );
          },
        );
        ...
        return _buildListWrapper(
          ...
          builder: (m) {
            ...
            return _listTile(
              ...
              trailing: Wrap(
                ...
                children: [
                  _statusBadge(
                    ...
                    m.status == MotoristaStatus.ativo
                        ? AppColors.success
                        : AppColors.error,
                  ),
              ...
              onEdit: Perfil.ehAdministrador(widget.userRole)
                  ...
                  : null,
              onDelete: Perfil.ehAdministrador(widget.userRole)
                  ? () => _confirmDelete(
                      context,
                      nome: m.nome,
            ...
            child: Column(
              children: [
                ...
                _buildRegistrationCard(
                  title: 'Colaboradores',
                  icon: Icons.people_rounded,
                  bullets: ['Função / Cargo', 'Permissões de acesso · Status'],
